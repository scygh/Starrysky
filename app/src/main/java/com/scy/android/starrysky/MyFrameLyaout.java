...
public class MyFrameLyaout extends FrameLayout {
    ...
    public MyFrameLyaout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_DOWN:
            if (arg == 1) {
                ParticleSystem ps = new ParticleSystem(this, 100, getResources().getDrawable(R.drawable.star_white), 1500);
            ...
            if (arg == 3){
                ...
                ParticleSystem ps = new ParticleSystem(this, 100, getResources().getDrawable(R.drawable.fireworks_a), 1500);
                ps.setScaleRange(0.1f, 0.4f);
                ps.setSpeedRange(0.02f, 0.08f);
                ps.setRotationSpeedRange(90, 180);
                ps.setFadeOut(200, new AccelerateInterpolator());
