...
public class SpiderWebView extends View {
    ...
    private void initPaint() {
        ...
        mTouchPaint.setColor(getResources().getColor(R.color.touchPointColor));
    }
    ...
    private void initPoint() {
        for (int i = 0; i < mConfig.pointNum; i++) {
            ...
            point.color = getResources().getColor(R.color.bright_sun);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //北斗
        canvas.drawCircle(mWidth/2 - 70, mHeight/2 + 200 - 120, new Random().nextInt(mConfig.pointRadius), mPointPaint);
        canvas.drawCircle(mWidth/2 + 10, mHeight/2 + 200 - 140, new Random().nextInt(mConfig.pointRadius), mPointPaint);
        canvas.drawCircle(mWidth/2 + 42 , mHeight/2 + 200 - 42, new Random().nextInt(mConfig.pointRadius), mPointPaint);
        canvas.drawCircle(mWidth/2, mHeight/2 + 200, 3, mPointPaint);
        canvas.drawCircle(mWidth/2, mHeight/2 + 70 + 200, 6, mPointPaint);
        canvas.drawCircle(mWidth/2 - 10, mHeight/2 + 200 + 140, 5, mPointPaint);
        canvas.drawCircle(mWidth/2 + 70, mHeight/2 + 200 + 230, 6, mPointPaint);
        //
        canvas.drawCircle(mWidth/2 - 120 + 500, mHeight/2 - 300, new Random().nextInt(mConfig.pointRadius)+4, mPointPaint);
        canvas.drawCircle(mWidth/2 + 500, mHeight/2 - 300 - 250, new Random().nextInt(mConfig.pointRadius)+4, mPointPaint);
        canvas.drawCircle(mWidth/2 - 220 + 500, mHeight/2 - 300 - 350, new Random().nextInt(mConfig.pointRadius)+4, mPointPaint);
        canvas.drawCircle(mWidth/2 - 170 + 500, mHeight/2 - 300 - 270, 3, mPointPaint);
        canvas.drawCircle(mWidth/2 - 120 + 500, mHeight/2 - 300 - 220, 3, mPointPaint);
        canvas.drawCircle(mWidth/2 - 80 + 500, mHeight/2 - 300 - 180, 3, mPointPaint);
        canvas.drawCircle(mWidth/2 - 110 + 500, mHeight/2 - 300 - 280, 3, mPointPaint);
        canvas.drawCircle(mWidth/2 - 90 + 500, mHeight/2 - 300 - 280 - 40, 3, mPointPaint);
        canvas.drawCircle(mWidth/2 - 210 + 500, mHeight/2 - 530, 3, mPointPaint);
        canvas.drawCircle(mWidth/2 - 270 + 500, mHeight/2 - 530, 3, mPointPaint);
        // 增强遍历
        int index = 0;
        for (SpiderPoint spiderPoint : mSpiderPointList) {
            ...
            canvas.drawCircle(spiderPoint.x, spiderPoint.y, new Random().nextInt(mConfig.pointRadius), mPointPaint);
