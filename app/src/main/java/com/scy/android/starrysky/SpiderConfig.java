...
/**
 * 沈程阳
 * created by scy on 2019/4/30 10:12
...
public class SpiderConfig {
    ...
    public static int DEFAULT_POINT_RADIUS = 6;

    public static int DEFAULT_LINE_WIDTH = 1;

    public static int DEFAULT_LINE_ALPHA = 100;

    // ~ 160
    public static int DEFAULT_POINT_NUMBER = 20;

    public static int DEFAULT_POINT_ACCELERATION = 3;
